		...
		<div class="panel-footer">		
			...
			<fieldset>
				...
				<div class="form-group col-sm-6">
					...
					<input class="form-control" id="tanggal" type="date" name="tanggal" value="" placeholder="tanggal" required>
				</div>	
				<div class="form-group col-sm-6">
					<label for="jam">Jam:<br></label>
					<select class="form-control" id="jam" name="jam" form="barangform">
						<?php for($i=0; $i<24;$i++):?>
						<option value="<?php if($i < 10){echo '0'.$i;}else{echo $i;}?>" <?php if($i == 10){echo 'selected';};?>><?php if($i < 10){echo '0'.$i;}else{echo $i;}?></option>	
						<?php endfor;?>
					</select>
				</div>					
				</div>					
				<div class="form-group">
					...
					<input class="form-control" id="durasi" type="number" name="durasi" min="1" max="10" value="" placeholder="durasi dalam jam" required>
				</div>			
				<div class="form-group">
				...
				<select class="form-control" id="ruang" name="ruang" form="barangform">
					...
					<option value="<?php echo $item->ID;?>"><?php echo $item->NAMA_RUANG;?></option>	
					<?php endforeach;?>
				</select>
				</div>				
