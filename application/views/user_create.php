			  <div class="panel-body">
					<form action="" id="inputform" method="post" class="form-horizontal">
					  <fieldset>
						...
						<div class="form-group">	
						<label for="password" class="col-sm-2">Password:<br></label>
						<div class="col-sm-10">		
						<input class="form-control" id="password" type="password" name="password" value="" placeholder="Password" required>
						</div>
						</div>
						<div class="form-group">	
						<label for="password2" class="col-sm-2">Repeat Password:<br></label>
						<div class="col-sm-10">		
						<input class="form-control" id="password2" type="password" name="password2" value="" placeholder="Repeat Password" required>
						</div>
						</div>
						<div class="form-group">	
						<label for="alias" class="col-sm-2">User Alias:<br></label>
						<div class="col-sm-10">		
						<input class="form-control" id="alias" type="text" name="alias" value="" placeholder="User Alias" required>
						</div>
						</div>
						<div class="form-group">	
