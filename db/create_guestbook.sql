...
CREATE TABLE IF NOT EXISTS `guestbook`.`GUEST_BOOK` (
  ...
  `CREATE_DATE` DATETIME NOT NULL DEFAULT NOW(),
  `UPDATE_DATE` DATETIME NOT NULL DEFAULT NOW(),
  `GUEST_BOOK_STATUS` VARCHAR(1) NULL DEFAULT 0,
  PRIMARY KEY (`ID`),
...
INSERT INTO `guestbook`.`REF_GENERAL` (`ID`, `REF_NAME`, `REF_STATUS`, `CREATE_DATE`, `UPDATE_DATE`, `REF_TYPE_ID`) VALUES (DEFAULT, 'Government', DEFAULT, DEFAULT, DEFAULT, 1);
INSERT INTO `guestbook`.`REF_GENERAL` (`ID`, `REF_NAME`, `REF_STATUS`, `CREATE_DATE`, `UPDATE_DATE`, `REF_TYPE_ID`) VALUES (DEFAULT, 'Private', DEFAULT, DEFAULT, DEFAULT, 1);
...
INSERT INTO `guestbook`.`COMPANY` (`ID`, `COMPANY_NAME`, `COMPANY_STATUS`, `CREATE_DATE`, `UPDATE_DATE`, `USER_ID`, `REF_GENERAL_ID`) VALUES (DEFAULT, 'Bank Mandiri', '1', DEFAULT, DEFAULT, DEFAULT, 3);
...
START TRANSACTION;
USE `guestbook`;
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (1, 'Guest Book', '#', 'book', '1', '1', '4', NULL, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (2, 'Meeting', '#', 'blackboard', '2', '1', '1,3,4', NULL, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (3, 'Package', '#', 'gift', '3', '1', '1,3,4', NULL, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (4, 'Room', '#', 'object-align-top', '4', '1', '1,3', NULL, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (5, 'Employees', '#', 'list-alt', '5', '1', '1,3', NULL, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (6, 'Company', '#', 'copyright-mark', '6', '1', '1,3', NULL, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (7, 'User', '#', 'user', '7', '1', '1', NULL, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (8, 'Init Data', '#', 'wrench', '8', '1', '1', NULL, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (9, 'Sign in', '#', 'check', '1', '1', '4', 1, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (10, 'Sign Out', '#', 'share', '2', '1', '4', 1, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (11, 'View', 'meeting', 'eye-open', '1', '1', '1,3,4', 2, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (12, 'Add', 'meeting/create', 'plus', '2', '1', '1,3,4', 2, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (13, 'View', 'packages', 'eye-open', '1', '1', '1,3,4', 3, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (14, 'Add', 'packages/create', 'plus', '2', '1', '1,3,4', 3, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (15, 'View', 'meeting_room', 'eye-open', '1', '1', '1,3', 4, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (16, 'Add', 'meeting_room/create', 'plus', '2', '1', '1,3', 4, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (17, 'View', 'employee', 'eye-open', '1', '1', '1,3', 5, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (18, 'Add', 'employee/create', 'plus', '2', '1', '1,3', 5, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (19, 'View', 'company', 'eye-open', '1', '1', '1,3', 6, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (20, 'Add', 'company/create', 'plus', '2', '1', '1,3', 6, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (21, 'View', 'user', 'eye-open', '1', '1', '1', 7, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (22, 'add', 'user/create', 'plus', '2', '1', '1', 7, DEFAULT, DEFAULT);
INSERT INTO `guestbook`.`MENU` (`ID`, `MENU_NAME`, `PERMALINK`, `MENU_ICON`, `MENU_ORDER`, `MENU_STATUS`, `ROLE_ACCESS`, `MENU_ID`, `CREATE_DATE`, `UPDATE_DATE`) VALUES (23, 'view', 'home/init_data', 'eye-open', '1', '1', '1', 8, DEFAULT, DEFAULT);
